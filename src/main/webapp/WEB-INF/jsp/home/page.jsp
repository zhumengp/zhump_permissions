        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>所有图标 <small class="m-l-sm">所有图标集合 - <a target="_blank" href="https://fortawesome.github.io/Font-Awesome/icons/default.htm">Font Awesome</a> </small></h5>
...
<script src="${pageContext.request.contextPath}/resources/js/content.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/welcome.min.js"></script>
</body>
</html>
